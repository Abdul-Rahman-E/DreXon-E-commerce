    ...
    <div className="w-screen flex flex-col items-center mt-8 mb-10">
      ...
      <div className="w-screen md:w-[1140px] flex justify-between items-center mt-5 mb-5 px-4 md:px-0">
        ...
        <select className="text-xs md:text-sm font-medium px-2 rounded-md shadow-sm shadow-slate-600">
          <option onClick={() => {setCurrentSort("name")}} value="Name">Name</option>
          <option onClick={() => {setCurrentSort("lth")}}  value="lth">Price: Low to High</option>
          <option onClick={() => {setCurrentSort("htl")}}  value="htl">Price: High to Low</option>
          <option onClick={() => {setCurrentSort("avg")}}  value="avg">Customer Review</option>
        </select>
      </div>
